...
#print(executar_rota("/projetos", "POST", {"titulo": "Olhos abertos", "curso": "ADS", "periodo": "2024.1", "descricao": "Outro projeto de integração para o curso de Análise e Desenvolvimento de Sistemas."}))
#print(executar_rota("/projetos", "POST", {"titulo": "", "curso": "", "periodo": "", "descricao": ""})) 

# Testando se quando projetos são cadastrados, eles aparecem na lista de projetos
